...
public class EditConsumers extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		count = 0;
		response = StudyMob.model.getUserConsumer(user_id);
		...
		//Add the current consumers into the list of checked classes
	...
	public void onClick(View v) {
		...
		if (v.equals(findViewById(R.id.submit))) {
			...
			builder.setMessage("Are you sure you want to edit the classes you need help with?")
			       .setCancelable(false)
			       .setPositiveButton("OK", new DialogInterface.OnClickListener() {
			           public void onClick(DialogInterface dialog, int id) {
			   				response = StudyMob.model.editConsumers(checked_classes, user_id);
			   				Toast.makeText(EditConsumers.this, "List of classes you need help with has been changed successfully", Toast.LENGTH_LONG).show();
			   				Intent i = new Intent(EditConsumers.this, EditProfile.class);
			   				startActivity(i);
			                EditConsumers.this.finish();
			           }
			       })
